####################################
# Script for training a Pepper model with label noise injected data
# Author: Ayse Dincer
...
all_results_df.T.to_csv('results/NCI-60_label_noise_simulation_results_original_model_noise_ratio_' + args.label_noise_ratio +'_run' + str(random_run) + '.tsv', sep = '\t')
